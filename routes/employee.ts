...
router.post('/createEmployee', urlencodedParser, async (req, res) => {
    let { name, departmentId, hiradate, levelId } = req.body;
    let sql = `INSERT INTO employee (name, departmentId, hiredate, levelId)
        VALUES('${name}', ${departmentId}, '${hiradate}', ${levelId})`;
...
router.post('/updateEmployee', async (req, res) => {
    let { id, name, departmentId, hiradate, levelId } = req.body
